...
use crate::service::{FullBackend, FullClient, HostFunctions};

/// Frontier DB backend type.
pub type FrontierBackend<B> = fc_db::Backend<B>;
...
pub async fn spawn_frontier_tasks<B, RA>(
    ...
    client: Arc<FullClient<B, RA, HostFunctions>>,
    backend: Arc<FullBackend<B>>,
    frontier_backend: Arc<FrontierBackend<B>>,
    filter_pool: Option<FilterPool>,
    storage_override: Arc<OverrideHandle<B>>,
    ...
    B: BlockT<Hash = H256>,
    // B::Header: Header<Hashing = HashingFor<B>>,
