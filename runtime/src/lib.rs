...
construct_runtime!(
    ...
    UncheckedExtrinsic = UncheckedExtrinsic
  {
    ...
    XcmpQueue: cumulus_pallet_xcmp_queue::{Pallet, Call, Storage, Event<T>} = 32,
    PolkadotXcm: pallet_xcm::{Pallet, Call, Storage, Event<T>, Origin} = 33,
    CumulusXcm: cumulus_pallet_xcm::{Pallet, Call, Event<T>, Origin} = 34,
